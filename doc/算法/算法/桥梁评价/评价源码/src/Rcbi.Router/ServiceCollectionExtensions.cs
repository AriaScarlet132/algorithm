...
namespace Rcbi.Router
{
    ...
    {
        public static IServiceCollection AddRcbiConsulRouter(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddOptions();
            services.Configure<ConsulServiceDiscoveryOption>(configuration.GetSection("ServiceDiscovery"));
            services.AddRcbiConsulRouter();
            return services;
        }

        public static IServiceCollection AddRcbiConsulRouter(this IServiceCollection services)
        {
