...
namespace Rcbi.AspNetCore.Helper
{
    public sealed class FileHelper
    {
        ...
        #region
        public static string GetMd5(string filePath, Encoding encoding = null)
        {
            using (var stream = File.OpenRead(filePath))
            {
                if(encoding == null) encoding = Encoding.UTF8;
                return GetMd5(stream, encoding);
            }
        }

        public static string GetMd5(FileStream stream, Encoding encoding = null)
        {
            if (encoding == null) encoding = Encoding.UTF8;
