...
namespace Rcbi.AspNetCore.Helper
{
    public sealed class HttpHelper
    {
        ...
        public string DoPost(string url, IDictionary<string, string> parameters)
        {
            ...
            Encoding encoding = rsp.CharacterSet.IsNullOrEmpty() ?
                Encoding.Default : Encoding.GetEncoding(rsp.CharacterSet);
        ...
        public string DoGet(string url, IDictionary<string, string> parameters)
        {
            ...
            HttpWebResponse rsp = (HttpWebResponse)req.GetResponse();
            Encoding encoding = Encoding.GetEncoding(!rsp.CharacterSet.IsNullOrEmpty() ? rsp.CharacterSet : "utf-8");
            return GetResponseAsString(rsp, encoding);
        }
        ...
        public static string BuildQuery(IDictionary<string, string> parameters)
        {
            ...
            while (dem.MoveNext())
            {
                ...
                postData.Append("=");
                postData.Append(HttpUtility.UrlEncode(value ?? string.Empty, Encoding.UTF8));
                hasParam = true;
                // 忽略参数名或参数值为空的参数
                /*
