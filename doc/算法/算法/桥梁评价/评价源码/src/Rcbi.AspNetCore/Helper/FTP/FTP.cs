...
namespace Rcbi.AspNetCore.Helper.Ftp
{
    ...
    public class FTP
    {
        ...
        private List<FTPFileInfo> _fileInfoList = new List<FTPFileInfo>();

        public FTP(string server, string user, string password, string folder) {
            Server = server;
            User = user;
            Password = password;
        ...
        public List<FTPFileInfo> GetFileListDetailed() {
        ...
        public List<FTPFileInfo> GetFileListDetailed(string fileSpec) {
        ...
        public List<FTPFileInfo> GetFileListDetailed(string fileSpec, bool forceRefresh) {
            ...
            if (forceRefresh ||
                ...
                try {
                    using (FtpWebResponse resp = (FtpWebResponse)req.GetResponse()) {
                        using (StreamReader reader = new StreamReader(resp.GetResponseStream())) {
                            while (!reader.EndOfStream) {
                                ftpFileInfo = new FTPFileInfo(reader.ReadLine());
        ...
        private DateTime GetFileDateTimeByListingFiles(string filename) {
            ...
            foreach (FTPFileInfo fileInfo in _fileInfoList) {
        ...
        private FTPFileInfo GetFileInfo(string filename) {
